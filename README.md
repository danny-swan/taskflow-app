...
PolyForm Noncommercial 1.0.0 — см. [LICENSE](LICENSE). Разрешено использование, форки и модификация для личных и других некоммерческих целей.
Для коммерческого использования свяжитесь со мной для получения отдельной лицензии.
