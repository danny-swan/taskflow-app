...
### 🟡 Актуальные жёсткие зависимости (работают, но легко сломать при следующей правке)
