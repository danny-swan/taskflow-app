...
### 7.31. Первый вход в свежий free-аккаунт: сид-статусы уезжали на `ws_local`, а welcome-задача — на `ws_<uid>` → «Задачи» пустые при целых данных (F36, ⚠️ реализовано, тесты зелёные, ждёт ручную проверку, 03.08.2026)
