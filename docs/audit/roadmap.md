...
2a. ✅ Миграция `0025_task_hold_periods.sql` уже применена на прод 12.07.2026 (к моменту выпуска v1.0.2 клиент будет пушить в уже существующую таблицу).
