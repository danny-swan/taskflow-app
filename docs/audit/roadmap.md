...
### 7.44. Справочники статусов и тегов рендерились на двух экранах сразу, а `WorkspaceSettings.tsx` импортировал их прямо из `pages/Settings.tsx` (F49, ADR 0035, PR [#119](https://github.com/danny-swan/taskflow-app/pull/119), 05.08.2026 — 🟡 ждёт ручной проверки пользователем)
...
### 7.45. Тепловая карта «Активность · 12w» на Дашборде: строка «Пн» показывала данные другого дня недели (F50, PR [#119](https://github.com/danny-swan/taskflow-app/pull/119), 05.08.2026 — 🟡 ждёт ручной проверки пользователем)
...
### 7.46. В «Истории» у самого себя рисовался аватар-заглушка, хотя во вкладке «Участники» аватар был верный (F51, PR [#119](https://github.com/danny-swan/taskflow-app/pull/119), 05.08.2026 — 🟡 ждёт ручной проверки пользователем)
...
### 7.47. Кнопка «Оплатить» в тарифе «Ежегодно» — белый текст на светлой карточке: страница `/checkout` свёрстана на несуществующих цветовых токенах (F52, PR [#119](https://github.com/danny-swan/taskflow-app/pull/119), 05.08.2026 — 🟡 ждёт ручной проверки пользователем)
